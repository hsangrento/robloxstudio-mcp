...
### 7. Eş zamanlı çok ajan → kuyruk, timeout, tekrar deneme ✅ (commit 0fb1d19 + revizyon COMMIT07B: otomatik dedupe yalnız pending ya da teslim edilmemiş (waiterEndedAt) sonuçlar için — teslim edilmiş sonuç yeniden çalıştırmayı engellemez, runtime-bridge-lifecycle regresyonu; test tests/todo-2026-09-15/07-queue-dedupe.mjs + request-recovery-tools/bridge-service/payload-timeout-diagnostics jest; kanıt kanit/07-queue-dedupe.md)
